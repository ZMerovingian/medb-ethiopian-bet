    ...
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Welcome Badge */}
          <Badge className="mb-8 bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 text-yellow-400 border-yellow-500/30 text-sm px-4 py-2">
            🇪🇹 Welcome to Ethiopia's Premier Betting Platform
          </Badge>

          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-yellow-100 to-yellow-400 bg-clip-text text-transparent leading-tight">
            MEDB
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button 
              ...
              className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-slate-900 font-semibold px-8 py-4 text-lg shadow-lg hover:shadow-yellow-500/25 transition-all duration-300"
            >
